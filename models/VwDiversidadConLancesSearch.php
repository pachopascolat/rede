...
/**
 * app\models\VwDiversidadConLancesSearch represents the model behind the search form about `app\models\VwDiversidadConLances`.
 */
 class VwDiversidadConLancesSearch extends VwDiversidadConLances
{
    /**
     * @inheritdoc
     */
    public function rules()
    {
        return [
            ...
            [['lance_id', 'transecta', 'nombre_vulgar', 'id_lance', 'fecha', 'campania_id', 'nombre', 'hora_inicio', 'hora_fin', 'tiempo_arrastre', 'direccion_viento', 'tipo_fondo', 'geography'], 'safe'],
    ...
    {
        $query = VwDiversidadConLances::find();
        ...
        $query->andFilterWhere(['like', 'lance_id', $this->lance_id])
            ...
            ->andFilterWhere(['like', 'id_lance', $this->id_lance])
