...
<?=             
             Html::a('<i class="fa glyphicon glyphicon-hand-up"></i> ' . Yii::t('app', 'PDF'), 
                ['pdf', 'id' => $model->id_info_diversidad],
                [
            ...
            <?= Html::a(Yii::t('app', 'Update'), ['update', 'id' => $model->id_info_diversidad], ['class' => 'btn btn-primary']) ?>
            <?= Html::a(Yii::t('app', 'Delete'), ['delete', 'id' => $model->id_info_diversidad], [
                'class' => 'btn btn-danger',
                'data' => [
