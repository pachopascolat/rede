...
/* @var $model app\models\VwDiversidadConLancesSearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="form-vw-diversidad-con-lances-search">
    ...
    <?php /* echo $form->field($model, 'nombre_vulgar')->textInput(['maxlength' => true, 'placeholder' => 'Nombre Vulgar']) */ ?>

    <?php /* echo $form->field($model, 'id_lance')->textInput(['maxlength' => true, 'placeholder' => 'Id Lance']) */ ?>
    ...
    <?php /* echo $form->field($model, 'campania_id')->textInput(['maxlength' => true, 'placeholder' => 'Campania']) */ ?>

    <?php /* echo $form->field($model, 'nombre')->textInput(['maxlength' => true, 'placeholder' => 'Nombre']) */ ?>

    <?php /* echo $form->field($model, 'estrato_id')->textInput(['placeholder' => 'Estrato']) */ ?>
